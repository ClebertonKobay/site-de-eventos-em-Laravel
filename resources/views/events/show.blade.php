    ...
    <div class="col-md-10 offset-md-1">
        <div class="row">
            <div id="image-container" class="col-md-6">
                <img class="img-fluid" src="/img/events/{{$event->image ? $event->image : "event_placeholder.jpg"}}" alt="{{$event->title}}">
            </div>
            <div id="info-container" class="col-md-6">
                ...
                @if ($hasUserJoined)
                    <form action="/events/leave/{{$event->id}}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger delete-btn" id="btn-sair">
